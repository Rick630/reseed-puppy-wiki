...
module.exports = {
  ...
  title: "Reseed Puppy Wiki",
  description: "Reseed Puppy  文档",
  base: '/reseed-puppy-wiki/', // 默认'/'。如果你想将你的网站部署到如 https://foo.github.io/bar/，那么 base 应该被设置成 "/bar/",（否则页面将失去样式等文件）
  head: [
  ...
  themeConfig: {
    ...
    logo: "", // 导航栏logo
    repo: "Reseed-Puppy/Reseed-Puppy", // 导航栏右侧生成Github链接
